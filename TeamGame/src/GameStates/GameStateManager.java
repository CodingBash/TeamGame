...
public class GameStateManager implements Controllable {
	...
	public static final int MENUSTATE = 0; // This is the index in array for the
											// "menu state"
	public static final int GAMESTATE = 1; // This is the index in array for the
											// "level state"
	...
	public GameStateManager() {
		...
		currentState = 0;
		gameStates.add(new MenuState(this)); // MenuState will have to be
												// created

	}

	/**
	 * setState() -Sets the currentState to the recieved state
	 * 
	 * @param state
	 */
